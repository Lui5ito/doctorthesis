...
python optimise_lengthscale/optimise_Kfolds.py --case_number $CASE --size $SIZE --dim $DIM --seed $SEED --num_folds 10 --l_bound 1e-8 --u_bound 10 --max_eval 100 --n_restarts 10
