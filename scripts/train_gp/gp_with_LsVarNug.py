"""
This file trains a Gaussian Process on given data, optimising three parameters:
    - lengthscale
    - variance
    - nugget
...
if __name__ == "__main__":
    ...
    BUCKET_OUT = "luisito/these/sb_experiments/train_gp/results/gp_with_LsVarNug/"
