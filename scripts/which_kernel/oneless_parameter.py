...
def compute(X_train, y_train, theta_v, X_cal, y_cal, X_test, y_test, save):
    ...
    # Reconstruct the posterior kernel with sklearn, without the Gaussian Noise
...
if __name__ == "__main__":
    ...
    for theta_v in all_theta_v:
        BUCKET_OUT = f"luisito/these/sb_experiments/which_kernel/results/oneless_parameter/lengthscale_{theta_v}/"
