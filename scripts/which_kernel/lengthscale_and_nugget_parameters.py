...
We use the kernel(lengthscale, nugget) to compute s and the kernel(lengthscale, nugget) in the SDP problem.
...
if __name__ == "__main__":
    ...
    for theta_v in all_theta_v:
        BUCKET_OUT = f"luisito/these/sb_experiments/which_kernel/results/ls_and_nug_parameters/lengthscale_{theta_v}/"
